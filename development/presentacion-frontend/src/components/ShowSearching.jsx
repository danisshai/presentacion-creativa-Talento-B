...
function ShowSearching(props) {
    ...
    return (
        <div className="container valign center" >
            <img src="https://raw.githubusercontent.com/danisshai/presentacion-creativa-Talento-B/main/development/imagenes/loading.gif" alt="Loading"  style={{width:"100%", maxWidth: "300px"}}/>
